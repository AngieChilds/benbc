...
class GeneralsControllerTest < ActionController::TestCase
  ...
  test "should create general" do
    assert_difference('General.count') do
      post :create, general: { author: @general.author, more: @general.more, publisher: @general.publisher, title: @general.title, year: @general.year }
    end
  ...
  test "should update general" do
    patch :update, id: @general, general: { author: @general.author, more: @general.more, publisher: @general.publisher, title: @general.title, year: @general.year }
    assert_redirected_to general_path(assigns(:general))
  end
